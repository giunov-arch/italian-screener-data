...
def run_screener():
    ...
    for symbol in TICKERS:
        try:
            ...
            # Timeout set to 30 seconds to allow Cloudflare background processing
    ...
    if payload_batch:
        ...
        try:
            res = requests.post(f"{WORKER_URL}/api/update-screener", json=payload_batch, headers=HEADERS, timeout=30)
